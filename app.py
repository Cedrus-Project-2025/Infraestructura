...
# ===== Endpoints Web
from Scripts.Desarrollo_Web.configs_general import ObtenerConfigsGeneral


api.add_resource(ObtenerConfigsGeneral,     '/api/w/configs_general')


if __name__ == '__main__':
    app.run(debug=True)  # <-- ¡Esto inicia el servidor!